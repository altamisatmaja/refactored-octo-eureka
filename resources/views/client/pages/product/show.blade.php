            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 text-center">
                        <img src="{{ asset('images/items/big-4.jpg') }}" class="img-fluid img-rounded mb-sm-30"
                            alt="">
                    </div>
                    <div class="col-md-6">
                        <div class="item_info">
                            Auctions ends in <div class="de_countdown" data-year="2022" data-month="4" data-day="16"
                                data-hour="8"></div>
                                    ...
                                    <div class="item_author">
                                        <div class="author_list_pp">
                                            <a href="collection.html">
                                                <img class="lazy"
                                                    src="{{ asset('images/collections/coll-thumbnail-1.jpg') }}"
                                                    alt="">
                                                <i class="fa fa-check"></i>
                                            </a>
                                        </div>
                            ...
                            <div class="de_tab tab_simple">
                                ...
                                <h6>Price</h6>
                                <div class="nft-item-price"><img src="{{ asset('images/misc/ethereum.svg') }}"
                                        alt=""><span>0.059</span>($253.67)</div>

                                <!-- Button trigger modal -->
                                <a href="#" class="btn-main btn-lg" data-bs-toggle="modal"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="p-3 form-border">
                        ...
                        <input type="text" name="buy_now_qty" id="buy_now_qty" class="form-control"
                            value="1" />
                        <div class="spacer-single"></div>
                        <div class="de-flex">
