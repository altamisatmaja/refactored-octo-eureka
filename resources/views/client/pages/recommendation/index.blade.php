        ...
        <section aria-label="section">
            <div class="container">
                <div class="row wow fadeIn">
                        ...
                        <div class="nft__item">
                            <div class="author_list_pp">
                                <a href="author.html" data-bs-toggle="tooltip" data-bs-placement="top"
                                    ...
                                    <img class="lazy" src="{{ asset('images/author/author-10.jpg') }}" alt="">
                                    <i class="fa fa-check"></i>
                                </a>
                            </div>
                            <div class="nft__item_wrap">
                                ...
                                <a href="item-details.html">
                                    <img src="{{ asset('images/items/static-2.jpg') }}" class="lazy nft__item_preview"
                                        alt="">
                                </a>
                            </div>
                            <div class="nft__item_info">
                    ...
                    <div class="d-item col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="nft__item">
                            <div class="de_countdown" data-year="2022" data-month="4" data-day="14" data-hour="8">
                            </div>
                            <div class="author_list_pp">
                                <a href="author.html" data-bs-toggle="tooltip" data-bs-placement="top"
                                    title="Creator: Ida Chapman">
                                    <img class="lazy" src="{{ asset('images/author/author-11.jpg') }}" alt="">
                                    <i class="fa fa-check"></i>
                                </a>
                            </div>
                            <div class="nft__item_wrap">
                                ...
                                <a href="item-details.html">
                                    <img src="{{ asset('images/items/static-3.jpg') }}" class="lazy nft__item_preview"
                                        alt="">
                                </a>
                            </div>
                            <div class="nft__item_info">
                        ...
                        <div class="nft__item">
                            <div class="author_list_pp">
                                <a href="author.html" data-bs-toggle="tooltip" data-bs-placement="top"
                                    ...
                                    <img class="lazy" src="{{ asset('images/author/author-12.jpg') }}" alt="">
                                    <i class="fa fa-check"></i>
                                </a>
                            </div>
                            <div class="nft__item_wrap">
                                ...
                                <a href="item-details.html">
                                    <img src="{{ asset('images/items/static-4.jpg') }}" class="lazy nft__item_preview"
                                        alt="">
                                </a>
                            </div>
                            <div class="nft__item_info">
                        ...
                        <div class="nft__item">
                            <div class="author_list_pp">
                                <a href="author.html" data-bs-toggle="tooltip" data-bs-placement="top"
                                    ...
                                    <img class="lazy" src="{{ asset('images/author/author-9.jpg') }}" alt="">
                                    <i class="fa fa-check"></i>
                                </a>
                            </div>
                            <div class="nft__item_wrap">
                                ...
                                <a href="item-details.html">
                                    <img src="{{ asset('images/items/anim-4.webp') }}" class="lazy nft__item_preview"
                                        alt="">
                                </a>
                            </div>
                            <div class="nft__item_info">
                    ...
                    <div class="d-item col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="nft__item">
                            ...
                            <div class="nft__item_wrap">
                                ...
                                <a href="item-details.html">
                                    <img src="{{ asset('images/items/anim-2.webp') }}" class="lazy nft__item_preview"
                                        alt="">
                                </a>
                            </div>
                            <div class="nft__item_info">
                    ...
                    <div class="d-item col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="nft__item">
                            ...
                            <div class="nft__item_wrap">
                                ...
                                <a href="item-details.html">
                                    <img src="{{ asset('images/items/anim-1.webp') }}" class="lazy nft__item_preview"
                                        alt="">
                                </a>
                            </div>
                            <div class="nft__item_info">
                    ...
                    <div class="d-item col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="nft__item">
                            <div class="de_countdown" data-year="2022" data-month="4" data-day="8" data-hour="8">
                            </div>
                            <div class="author_list_pp">
                                <a href="author.html" data-bs-toggle="tooltip" data-bs-placement="top"
                                    title="Creator: Lori Hart">
                                    <img class="lazy" src="{{ asset('images/author/author-4.jpg') }}" alt="">
                                    <i class="fa fa-check"></i>
                                </a>
                            </div>
                            <div class="nft__item_wrap">
                                ...
                                <a href="item-details.html">
                                    <img src="{{ asset('images/items/anim-5.webp') }}" class="lazy nft__item_preview"
                                        alt="">
                                </a>
                            </div>
                            <div class="nft__item_info">
                    ...
                    <div class="d-item col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="nft__item">
                            <div class="de_countdown" data-year="2022" data-month="4" data-day="16" data-hour="8">
                            </div>
                            <div class="author_list_pp">
                                <a href="author.html" data-bs-toggle="tooltip" data-bs-placement="top"
                            ...
                            <div class="nft__item_wrap">
                                ...
                                <a href="item-details.html">
                                    <img src="{{ asset('images/items/anim-3.webp') }}" class="lazy nft__item_preview"
                                        alt="">
                                </a>
                            </div>
                            <div class="nft__item_info">
                    ...
                    <div class="d-item col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="nft__item">
                            ...
                            <div class="nft__item_wrap">
                                ...
                                <a href="item-details.html">
                                    <img src="{{ asset('images/items/static-5.jpg') }}" class="lazy nft__item_preview"
                                        alt="">
                                </a>
                            </div>
                            <div class="nft__item_info">
                    ...
                    <div class="d-item col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="nft__item">
                            ...
                            <div class="nft__item_wrap">
                                ...
                                <a href="item-details.html">
                                    <img src="{{ asset('images/items/anim-6.webp') }}" class="lazy nft__item_preview"
                                        alt="">
                                </a>
                            </div>
                            <div class="nft__item_info">
                    ...
                    <div class="d-item col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="nft__item">
                            ...
                            <div class="nft__item_wrap">
                                ...
                                <a href="item-details.html">
                                    <img src="{{ asset('images/items/anim-7.webp') }}" class="lazy nft__item_preview"
                                        alt="">
                                </a>
                            </div>
                            <div class="nft__item_info">
                    ...
                    <div class="d-item col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="nft__item">
                            ...
                            <div class="nft__item_wrap">
                                ...
                                <a href="item-details.html">
                                    <img src="{{ asset('images/items/static-6.jpg') }}" class="lazy nft__item_preview"
                                        alt="">
                                </a>
                            </div>
                            <div class="nft__item_info">
                    ...
                    <div class="d-item col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="nft__item">
                            ...
                            <div class="nft__item_wrap">
                                ...
                                <a href="item-details.html">
                                    <img src="{{ asset('images/items/anim-8.webp') }}" class="lazy nft__item_preview"
                                        alt="">
                                </a>
                            </div>
                            <div class="nft__item_info">
                    ...
                    <div class="d-item col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="nft__item">
                            ...
                            <div class="nft__item_wrap">
                                ...
                                <a href="item-details.html">
                                    <img src="{{ asset('images/items/static-7.jpg') }}" class="lazy nft__item_preview"
                                        alt="">
                                </a>
                            </div>
                            <div class="nft__item_info">
